...
python $cosyvoice_dir/tools/make_parquet_list.py       --num_utts_per_parquet 1000       --num_processes 10       --src_dir $cosyvoice_data_dir/$split       --des_dir $cosyvoice_data_dir/$split/parquet       --hdf5_file $data_dir/segments.h5       --sample_rate 16000       --nshard 10       --shard_rank 7
