...
torchrun --nnodes=1 --nproc_per_node=$num_gpus \
      --rdzv_id=$job_id --rdzv_backend="c10d" --rdzv_endpoint="localhost:3456" \
../../../../cosyvoice/bin/train.py \
--train_engine $train_engine \
--config ../conf/cosyvoice2_prosody_tokens.yaml \
...
--model_dir `pwd`/../exp/cosyvoice2_w_prosody_tokens/$model/$train_engine \
--tensorboard_dir `pwd`/../tensorboard/cosyvoice2_w_prosody_tokens/$model/$train_engine \
